      ...
      >
        <div className="relative h-[328px] overflow-hidden rounded-[38px] bg-neutral-200 dark:bg-neutral-950/50">
          ...
          <motion.div
            ...
            className="absolute left-[138px] top-2 hidden h-7 w-7 items-center justify-center rounded-full dark:flex"
          >
          ...
          <motion.div
            ...
            className="absolute left-[138px] top-2 flex h-7 w-7 items-center justify-center rounded-full dark:hidden"
          >
            <svg viewBox="0 0 16 16" className="h-4 w-4">
              <g fill="#404040">
                <path d="M3 8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8Z"></path>
              ...
              <div className="">
                <div className="flex w-full flex-col overflow-hidden">
                  <div className="flex w-full items-center justify-between">
                    ...
                    <span className="pr-6 text-[10px] text-neutral-500 sm:pr-2">
                      {notificationTime}
                    </span>
                  </div>
...
const IconWrapper = ({ children }: { children?: React.ReactNode }) => {
  return (
    <div className="relative flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-neutral-300 to-neutral-200 dark:from-neutral-700 dark:to-neutral-900">
      {children}
    </div>
  );
};
